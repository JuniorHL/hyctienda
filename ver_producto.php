...
<section class="quick-view">
   ...
   <h1 class="heading">Informacion del Producto</h1>

   <?php
     $pid = $_GET['pid'];
     $select_products = $conn->prepare("SELECT * FROM `producto` WHERE id = ?"); 
   ...
   <form action="" method="post" class="box">
      ...
      <div class="row">
         <div class="image-container">
            ...
            <div class="sub-image">
               <img src="uploaded_img/<?= $fetch_product['imagen1']; ?>" alt="">
               <img src="uploaded_img/<?= $fetch_product['imagen2']; ?>" alt="">
               <img src="uploaded_img/<?= $fetch_product['imagen3']; ?>" alt="">
            </div>
         </div>
         <div class="content">
            ...
            <div class="flex-btn">
               <input type="submit" value="Añadir a pedido" class="btn" name="add_to_cart">
               <input class="option-btn" type="submit" name="add_to_wishlist" value="Añadir a mis favoritos">
            </div>
         </div>
      </div>
   </form>
   <?php
      ...
      echo '<p class="empty">No se puede visualizar el producto.</p>';
   }
   ?>
