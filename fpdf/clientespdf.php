...
while ($fetch_cliente = $select_cliente->fetch(PDO::FETCH_ASSOC)) {
    $pdf->Cell(10, 10, utf8_decode($fetch_cliente['id']), 1, 0, 'C');
    $pdf->Cell(60, 10, utf8_decode($fetch_cliente['nombre'].' '.$fetch_cliente['apellido']), 1, 0, 'C');
    $pdf->Cell(30, 10, utf8_decode($fetch_cliente['DNI']), 1, 0, 'C');
    $pdf->Cell(30, 10, utf8_decode($fetch_cliente['telefono']), 1, 1, 'C');
}
