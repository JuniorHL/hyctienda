...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(40, 10, utf8_decode('CLIENTE'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('FACTURA'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('FECHA- HORA'), 1, 0, 'C', 1);
      $this->Cell(45, 10, utf8_decode('CANT. PRODCUTOS'), 1, 0, 'C', 1);
...
while ($fetch_venta = $select_venta->fetch(PDO::FETCH_ASSOC)) {
    $pdf->Cell(10, 10, utf8_decode($fetch_venta['id']), 1, 0, 'C');
    $pdf->Cell(40, 10, utf8_decode($fetch_venta['nombre']), 1, 0, 'C');
    $pdf->Cell(30, 10, utf8_decode($fetch_venta['codigo']), 1, 0, 'C');
    $pdf->Cell(50, 10, utf8_decode($fetch_venta['fecha']), 1, 0, 'C');
    $pdf->Cell(45, 10, utf8_decode($fetch_venta['cantProd']), 1, 0, 'C');
    $pdf->Cell(20, 10, utf8_decode($fetch_venta['importeTotal']), 1, 1, 'C');
}
